"""
Django settings for ngoppish project.
...
SECRET_KEY = 'django-insecure-!#xzx78eobf__*q0b7ukt4r#1k#h-4a8dhra&ij@x3ztw0x51_'
...
WSGI_APPLICATION = 'ngoppish.wsgi.application'
